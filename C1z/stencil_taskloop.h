...
void star1_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=1; i<n-1; i++) {
    OMP_SIMD
    for (int j=1; j<n-1; j++) {
...
void star2_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=2; i<n-2; i++) {
    OMP_SIMD
    for (int j=2; j<n-2; j++) {
...
void star3_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=3; i<n-3; i++) {
    OMP_SIMD
    for (int j=3; j<n-3; j++) {
...
void star4_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=4; i<n-4; i++) {
    OMP_SIMD
    for (int j=4; j<n-4; j++) {
...
void star5_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=5; i<n-5; i++) {
    OMP_SIMD
    for (int j=5; j<n-5; j++) {
...
void star6_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=6; i<n-6; i++) {
    OMP_SIMD
    for (int j=6; j<n-6; j++) {
...
void star7_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=7; i<n-7; i++) {
    OMP_SIMD
    for (int j=7; j<n-7; j++) {
...
void star8_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=8; i<n-8; i++) {
    OMP_SIMD
    for (int j=8; j<n-8; j++) {
...
void star9_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=9; i<n-9; i++) {
    OMP_SIMD
    for (int j=9; j<n-9; j++) {
...
void grid1_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=1; i<n-1; i++) {
    OMP_SIMD
    for (int j=1; j<n-1; j++) {
...
void grid2_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=2; i<n-2; i++) {
    OMP_SIMD
    for (int j=2; j<n-2; j++) {
...
void grid3_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=3; i<n-3; i++) {
    OMP_SIMD
    for (int j=3; j<n-3; j++) {
...
void grid4_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=4; i<n-4; i++) {
    OMP_SIMD
    for (int j=4; j<n-4; j++) {
...
void grid5_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=5; i<n-5; i++) {
    OMP_SIMD
    for (int j=5; j<n-5; j++) {
...
void grid6_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=6; i<n-6; i++) {
    OMP_SIMD
    for (int j=6; j<n-6; j++) {
...
void grid7_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=7; i<n-7; i++) {
    OMP_SIMD
    for (int j=7; j<n-7; j++) {
...
void grid8_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=8; i<n-8; i++) {
    OMP_SIMD
    for (int j=8; j<n-8; j++) {
...
void grid9_2d(const int n,const int gs,  const double (* restrict in)[n], double (* restrict out)[n]) {
  OMP_TASKLOOP( firstprivate(n) shared(in,out) grainsize(gs) )
  for (int i=9; i<n-9; i++) {
    OMP_SIMD
    for (int j=9; j<n-9; j++) {
